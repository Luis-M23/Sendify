...
import { Package, TrendingUp, Clock, CheckCircle2, AlertCircle } from "lucide-react"
    ...
    <DashboardLayout userRole="vip">
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Gestiona tus envíos internacionales desde un solo lugar</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Llegada estimada 3-7 días</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Ahorro VIP</CardTitle>
              <TrendingUp className="h-4 w-4 text-chart-4" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">$342</div>
              <p className="text-xs text-muted-foreground mt-1">15% de descuento aplicado</p>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">Entregado - Miami, FL</p>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">En tránsito - Nueva York</p>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">En aduana - Los Ángeles</p>
                </div>
        ...
        <Card className="border-chart-4/50 bg-chart-4/5">
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                <CardTitle className="text-base">Beneficio VIP Disponible</CardTitle>
                <CardDescription>
                  Tienes un envío express gratis disponible este mes. ¡Aprovéchalo antes de que expire!
                </CardDescription>
              </div>
            </div>
          </CardHeader>
